...
class We1:
    ...
    def we_q1_wait(self):
        Wait = WebDriverWait(self.driver, 10).until(
            ec.visibility_of_element_located((We1.we_q1)))

    def we_quest1(self):
        return self.driver.find_element(*We1.we_q1)

    def we_quest2(self):
        return self.driver.find_element(*We1.we_q2)

    def we_quest3(self):
        return self.driver.find_element(*We1.we_q3)

    def we_quest4(self):
        return self.driver.find_element(*We1.we_q4)

    def we_quest5(self):
        return self.driver.find_element(*We1.we_q5)

    def we_q6_wait(self):
        Wait = WebDriverWait(self.driver, 10).until(
            ec.visibility_of_element_located((We1.we_q6)))

    def we_quest6(self):
        return self.driver.find_element(*We1.we_q6)

    def we_quest7(self):
        return self.driver.find_element(*We1.we_q7)

    def we_quest8(self):
        return self.driver.find_element(*We1.we_q8)

    def we_quest9(self):
        return self.driver.find_element(*We1.we_q9)

    def we_quest10(self):
        return self.driver.find_element(*We1.we_q10)

    def we_q11_wait(self):
        Wait = WebDriverWait(self.driver, 10).until(
            ec.visibility_of_element_located((We1.we_q11)))

    def we_success_message(self):
        return self.driver.find_element(*We1.we_success)

    def we_quest11(self):
        return self.driver.find_element(*We1.we_q11)

    def we_quest12(self):
        return self.driver.find_element(*We1.we_q12)

    def submit_wait(self):
        wait = WebDriverWait(self.driver, 10).until(ec.visibility_of_element_located(We1.submit_button))

    def submit(self):
        return self.driver.find_element(*We1.submit_button)

    def tq_again_wait(self):
        wait = WebDriverWait(self.driver, 10).until(ec.visibility_of_element_located((We1.Tq_again)))

    def take_quiz_again(self):
        button = WebDriverWait(self.driver, 5).until(ec.element_to_be_clickable(We1.Tq_again))
        return button
