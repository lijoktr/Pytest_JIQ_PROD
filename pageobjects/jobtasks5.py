...
class jt5:
    ...
    def jt_q1_wait(self):
        Wait = WebDriverWait(self.driver, 10).until(
            ec.visibility_of_element_located((jt5.jt_q1)))

    def jt_quest1(self):
        return self.driver.find_element(*jt5.jt_q1)

    def jt_quest2(self):
        return self.driver.find_element(*jt5.jt_q2)

    def jt_quest3(self):
        return self.driver.find_element(*jt5.jt_q3)

    def jt_quest4(self):
        return self.driver.find_element(*jt5.jt_q4)

    def jt_quest5(self):
        return self.driver.find_element(*jt5.jt_q5)

    def jt_q6_wait(self):
        Wait = WebDriverWait(self.driver, 10).until(
            ec.visibility_of_element_located((jt5.jt_q6)))

    def jt_quest6(self):
        return self.driver.find_element(*jt5.jt_q6)

    def jt_quest7(self):
        return self.driver.find_element(*jt5.jt_q7)

    def jt_quest8(self):
        return self.driver.find_element(*jt5.jt_q8)

    def jt_quest9(self):
        return self.driver.find_element(*jt5.jt_q9)

    def jt_quest10(self):
        return self.driver.find_element(*jt5.jt_q10)

    def jt_q11_wait(self):
        Wait = WebDriverWait(self.driver, 10).until(
            ec.visibility_of_element_located((jt5.jt_q11)))

    def jt_quest11(self):
        return self.driver.find_element(*jt5.jt_q11)

    def jt_quest12(self):
        return self.driver.find_element(*jt5.jt_q12)

    def jt_quest13(self):
        return self.driver.find_element(*jt5.jt_q13)
