...
class ci5:
    ...
    def q1_wait(self):
        Wait = WebDriverWait(self.driver, 10).until(
            ec.visibility_of_element_located((ci5.q1)))

    def quest1(self):
        return self.driver.find_element(*ci5.q1)
    ...
    def quest2(self):
        return self.driver.find_element(*ci5.q2)
    ...
    def quest3(self):
        return self.driver.find_element(*ci5.q3)
    ...
    def quest4(self):
        return self.driver.find_element(*ci5.q4)
    ...
    def quest5(self):
        return self.driver.find_element(*ci5.q5)
    ...
    def q6_wait(self):
        Wait = WebDriverWait(self.driver, 10).until(
            ec.visibility_of_element_located((ci5.q6)))

    def quest6(self):
        return self.driver.find_element(*ci5.q6)
    ...
    def quest7(self):
        return self.driver.find_element(*ci5.q7)

    def quest8(self):
        return self.driver.find_element(*ci5.q8)

    def quest9(self):
        return self.driver.find_element(*ci5.q9)

    def quest10(self):
        return self.driver.find_element(*ci5.q10)

    def q11_wait(self):
        Wait = WebDriverWait(self.driver, 10).until(
            ec.visibility_of_element_located((ci5.q11)))

    def quest11(self):
        return self.driver.find_element(*ci5.q11)

    def quest12(self):
        return self.driver.find_element(*ci5.q12)
