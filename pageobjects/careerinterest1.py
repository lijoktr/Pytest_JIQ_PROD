...
class ci1:
    ...
    def q1_wait(self):
        Wait = WebDriverWait(self.driver, 10).until(
            ec.visibility_of_element_located((ci1.q1)))
    ...
    def q6_wait(self):
        Wait = WebDriverWait(self.driver, 10).until(
            ec.visibility_of_element_located((ci1.q6)))
    ...
    def quest8(self):
        return self.driver.find_element(*ci1.q8)

    def quest9(self):
        return self.driver.find_element(*ci1.q9)

    def quest10(self):
        return self.driver.find_element(*ci1.q10)

    def q11_wait(self):
        Wait = WebDriverWait(self.driver, 10).until(
            ec.visibility_of_element_located((ci1.q11)))

    def quest11(self):
        return self.driver.find_element(*ci1.q11)

    def quest12(self):
        return self.driver.find_element(*ci1.q12)
